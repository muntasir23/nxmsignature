    ...
    <div className="p-5 md:p-10">
      ...
      <div className="flex md:flex-row justify-between items-center gap-4 mb-8">
        ...
        >
          ...
          <option value="full-sleeve-shirt">
            Full Sleeve Shirt
          </option>

          <option value="half-sleeve-shirt">
            Half Sleeve Shirt
          </option>

          <option value="remi-cotton-shirt">
            Remi Cotton Shirt
          </option>

          <option value="q-ban-shirt">
            Q Ban Shirt
          </option>

          <option value="formal-trouser">
            Formal Trouser
          </option>

          <option value="cotton-pant">
            Cotton Pant
          </option>
